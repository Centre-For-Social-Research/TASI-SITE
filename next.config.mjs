...
const siteSecurityHeaders = [
  {
    ...
    value: [
      "default-src 'self'",
      `script-src 'self' blob: 'unsafe-inline' 'unsafe-eval' ${clerkCspOrigins.join(' ')} https://cdn.jsdelivr.net https://challenges.cloudflare.com https://static.cloudflareinsights.com`,
