...
const imageMap = {
  ...
  'human-centered-solutions-social-media-harms':
    '/img/home-gallery/dr-ranjana-kumari.jpg',
  'tackling-harms-of-non-consensual-intimate-images':
    '/img/home-gallery/non-consensual-intimate-images-article.png',
};
