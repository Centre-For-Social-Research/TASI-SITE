      ...
      <main className="bg-white text-stone-900 dark:bg-stone-950 dark:text-stone-100">
        <BrandedPageHero>
          <div className="relative z-10 mx-auto w-full max-w-6xl px-4 text-center md:px-6">
            ...
            <p className="mx-auto mt-5 max-w-3xl text-base leading-relaxed text-white/90 md:text-lg">
              A landmark two-day convening in New Delhi that brought together government leaders, global technology
              platforms, diplomats, researchers, and civil society to reimagine safer digital ecosystems.
            </p>
        ...
        <section className="bg-[linear-gradient(180deg,#fffdf8_0%,#f6efe6_100%)] py-section-sm dark:bg-[linear-gradient(180deg,#111827_0%,#0b1220_100%)] md:py-section-lg">
          <div className="mx-auto grid w-full max-w-[1300px] items-center gap-10 px-4 md:grid-cols-[1.15fr_0.85fr] md:px-8 lg:px-16">
            <div>
              <p className="mb-4 text-xs font-black uppercase tracking-[0.18em] text-rc-accent dark:text-white md:text-sm">About the Festival</p>
              ...
              <p className="mt-5 text-body-lg leading-relaxed text-stone-700 dark:text-slate-300">
                TASI 2025 created a multi-stakeholder platform for digital safety dialogue in India, bringing together
                government, international diplomats, technology companies, academics, and civil society under a shared
              ...
              <div className="mt-8 rounded-[10px] border border-stone-200 bg-white p-6 shadow-lg shadow-stone-200/40 dark:border-slate-800 dark:bg-slate-900 md:p-7">
                <p className="mb-3 text-xs font-black uppercase tracking-[0.18em] text-rc-primary dark:text-white">Perspective</p>
                ...
                <p className="mt-5 text-sm font-medium text-stone-500 dark:text-slate-400">Caroline Humer, Co-Founder, Trust and Safety Festival</p>
              </div>
            </div>
        ...
        <section className="bg-white py-section-sm dark:bg-stone-950 md:py-section-lg">
          <div className="mx-auto w-full max-w-[1300px] px-4 md:px-8 lg:px-16">
            <p className="mb-4 text-xs font-black uppercase tracking-[0.18em] text-rc-accent dark:text-white md:text-sm">Thematic Focus</p>
            ...
            <p className="mt-5 max-w-3xl text-body-lg text-stone-700 dark:text-slate-300">
              The inaugural edition spanned core trust and safety concerns across governance, product design, online
              harms, and institutional response.
            </p>
            <div className="mt-12 grid gap-6 md:grid-cols-2 xl:grid-cols-3">
              {tracks.map(([title, desc]) => (
                ...
                >
                  <h3 className="text-2xl font-bold tracking-tight text-stone-900 dark:text-white">{title}</h3>
                  <div className="mt-5 h-1 w-14 rounded-full bg-rc-accent dark:bg-white"></div>
                  <p className="mt-5 text-body-md leading-relaxed text-stone-600 dark:text-slate-300">{desc}</p>
                </article>
              ))}
            </div>
          </div>
        ...
        <section className="bg-[linear-gradient(180deg,#f5f1ea_0%,#ffffff_100%)] py-section-sm md:py-section-lg">
          <div className="mx-auto grid w-full max-w-[1300px] items-center gap-10 px-4 md:grid-cols-[0.9fr_1.1fr] md:px-8 lg:px-16">
            ...
            <div>
              <p className="mb-4 text-xs font-black uppercase tracking-[0.18em] text-rc-accent md:text-sm">Inaugural Keynote</p>
              ...
              <div className="mt-8 rounded-[10px] border border-stone-200 bg-white p-6 shadow-lg shadow-stone-200/40 md:p-7">
                ...
                <p className="mt-5 text-sm font-medium text-stone-500">Dr. S. Jaishankar, quoting PM Narendra Modi</p>
              </div>
            </div>
          </div>
        </section>
        ...
        <section className="bg-gradient-to-br from-[#5c0f4f] via-[#360454] to-[#15002b] py-section-sm text-white md:py-section-lg">
          <div className="mx-auto w-full max-w-[1300px] px-4 md:px-8 lg:px-16">
            <p className="mb-4 text-xs font-black uppercase tracking-[0.18em] text-rc-secondary dark:text-white md:text-sm">Research and Data Spotlights</p>
            ...
            <div className="mt-12 grid gap-6 md:grid-cols-2 xl:grid-cols-3">
              {impacts.map(([num, label]) => (
                ...
                >
                  <p className="text-5xl font-black text-rc-secondary dark:text-white">{num}</p>
        ...
        <section className="bg-white py-section-sm md:py-section-lg">
          <div className="mx-auto w-full max-w-[1300px] px-4 md:px-8 lg:px-16">
            <p className="mb-4 text-xs font-black uppercase tracking-[0.18em] text-rc-accent md:text-sm">Recommendations</p>
            ...
            <div className="mt-12 grid gap-6 lg:grid-cols-[0.9fr_1.1fr]">
              <div className="rounded-[10px] bg-[linear-gradient(135deg,#350265_0%,#5c0f4f_100%)] p-8 text-white shadow-xl shadow-[#350265]/20 md:p-10">
                <p className="text-xs font-black uppercase tracking-[0.18em] text-rc-secondary dark:text-white">Strategic Direction</p>
                <h3 className="mt-4 text-3xl font-extrabold tracking-tight md:text-4xl">From dialogue to implementation</h3>
                <p className="mt-5 text-base leading-relaxed text-white/80">
                  TASI 2025 surfaced a clear mandate: build stronger year-round collaboration, develop more practical
                  governance frameworks, and center survivor-led, India-grounded trust and safety solutions.
                </p>
              </div>
              ...
              <div className="grid gap-5 md:grid-cols-2">
                {recommendations.map((item, index) => (
                  ...
                  >
                    ...
                    <p className="text-body-md leading-relaxed text-stone-800">{item}</p>
                  </article>
                ))}
              </div>
            </div>
        ...
        <section className="bg-[linear-gradient(180deg,#fffdf8_0%,#f6efe6_100%)] py-section-sm md:py-section-lg">
          <div className="mx-auto w-full max-w-[1300px] px-4 md:px-8 lg:px-16">
            <p className="mb-4 text-xs font-black uppercase tracking-[0.18em] text-rc-accent md:text-sm">What Comes Next</p>
            ...
            <div className="mt-12 overflow-hidden rounded-[10px] border border-stone-200 bg-white shadow-lg shadow-stone-200/40">
              <div className="grid gap-0 md:grid-cols-2">
                {future.map((item, index) => (
                  ...
                  >
                    <p className="text-xs font-black uppercase tracking-[0.16em] text-rc-accent">Next {String(index + 1).padStart(2, "0")}</p>
                    <p className="mt-4 text-lg font-semibold leading-relaxed text-stone-900">{item}</p>
                  </article>
                ))}
              </div>
            </div>
