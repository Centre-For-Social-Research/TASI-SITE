...
function Footerdemo() {
  ...
  return (
    <footer className="relative overflow-hidden border-t border-t-8 border-[#ff6900] bg-[linear-gradient(120deg,#55089e_-7.06%,#9f0099_16.19%,#ff0080_39.45%,#ef5700_85.96%,#ffff00_109.21%)] text-white transition-colors duration-300">
      <div className="pointer-events-none absolute inset-0 bg-[linear-gradient(180deg,rgba(10,10,20,0.28)_0%,rgba(8,8,18,0.58)_65%,rgba(5,5,12,0.82)_100%)]" />
      ...
      <div className="relative z-10 mx-auto w-full max-w-screen-xl px-10 py-8">
        <div className="grid gap-x-10 gap-y-10 items-start md:grid-cols-2 lg:grid-cols-5">
          <div className="relative">
            ...
            <form className="relative" onSubmit={handleNewsletterSubmit}>
              <Input
                ...
                className="border-white/30 bg-white/10 pr-12 text-white placeholder:text-white/65 backdrop-blur-sm"
              ...
              <Button
                ...
                className="absolute right-1 top-1 h-8 w-8 rounded-full bg-white text-[#140f26] transition-transform hover:scale-105"
              >
          ...
          <div>
            ...
            <form className="rounded-md border border-white/30 bg-black/20 p-3 backdrop-blur-sm" onSubmit={handleMessageSubmit}>
              <div className="space-y-2">
                <Input
                  type="email"
                  placeholder="Email"
                  className="h-8 border-white/30 bg-white/10 text-xs text-white placeholder:text-white/65"
                  value={messageEmail}
                ...
                <textarea
                  placeholder="Message"
                  className="min-h-[68px] w-full rounded-md border border-white/30 bg-white/10 px-2 py-1.5 text-xs text-white outline-none placeholder:text-white/65 focus-visible:ring-2 focus-visible:ring-white/80 focus-visible:ring-offset-2 focus-visible:ring-offset-transparent"
                  value={messageText}
                  onChange={(event) => setMessageText(event.target.value)}
                  minLength={10}
                  required
                />
                <Button type="submit" size="sm" className="h-8 w-full bg-white text-[#140f26] text-xs hover:bg-white/90" disabled={isMessageSubmitting}>
