...
function Footerdemo() {
  ...
  return (
    <footer className="relative overflow-hidden bg-[linear-gradient(120deg,#55089e_-7.06%,#9f0099_16.19%,#ff0080_39.45%,#ef5700_85.96%,#ffff00_109.21%)] text-white transition-colors duration-300">
      ...
      <div className="relative z-10 mx-auto w-full max-w-screen-xl px-10 py-8">
        <div className="grid gap-x-10 gap-y-10 items-start md:grid-cols-2 lg:grid-cols-4">
          ...
          <div>
            ...
            {/* items-start keeps each link at its text width, so the clickable
                area matches the label instead of spanning the whole column. */}
            <nav className="flex flex-col items-start gap-2 text-sm text-white/90">
              <Link
                href="/about"
          ...
          <div>
            ...
            <address className="space-y-2 text-sm text-white/90 not-italic">
              ...
              <p>New Delhi, India</p>
              <p>Email: india@trustandsafetyfestival.com</p>
            </address>
            <div className="mt-5 flex flex-col items-start gap-2 text-sm text-white/90">
              <a
