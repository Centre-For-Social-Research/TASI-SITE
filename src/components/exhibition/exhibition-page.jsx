...
import {
  exhibitionExtendedBranding,
  exhibitionHero,
  exhibitionParticipationModes,
  exhibitionProofPoints,
  exhibitionValueCards,
} from '@/data/exhibition-page';
        ...
        <section className="relative bg-gradient-to-br from-[#5c0f4f] via-[#360454] to-[#15002b] px-6 py-section-sm md:px-6 md:py-section-md lg:px-16 lg:py-section-lg">
          <div className="mx-auto grid w-full max-w-[1300px] gap-12 lg:grid-cols-[1fr_1fr] lg:items-center lg:gap-20">
            ...
            <div className="grid gap-5">
              {exhibitionProofPoints.map((point) => (
                <article
                  key={point.title}
        ...
        >
          <div className="container mx-auto max-w-[1300px] px-4 md:px-6">
            ...
            <div className="grid gap-6 md:grid-cols-3">
              {exhibitionParticipationModes.map((mode, index) => (
                <article
                  key={mode.title}
        ...
        <section className="border-t border-gray-100 bg-white py-section-md dark:border-gray-800 dark:bg-[#121212] md:py-section-lg">
          <div className="container mx-auto max-w-[1300px] px-4 md:px-6">
            ...
            <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
              {exhibitionExtendedBranding.map((item) => (
                <article
                  key={item.title}
                  className={`group relative flex flex-col overflow-hidden rounded-[10px] border border-stone-200 bg-gray-50 shadow-sm transition-shadow hover:shadow-md dark:border-stone-800 dark:bg-gray-900/50 ${
                    item.cardClassName ?? ''
                  }`}
                >
