...
export const attendeesHero = {
  eyebrow: 'Public Attendees',
  title: 'Meet the TASI community',
  description:
    'Explore one public-facing attendee directory built from the combined master, conference, embassy, and online registration lists. Search by person, organisation, event, or role and open each card for richer details.',
};

export const attendeesDirectoryCopy = {
  eyebrow: 'Public Attendees',
  title: 'Browse the festival community in one place',
  description:
    'Search across the consolidated TASI attendee list, explore by category and event, and open each profile for the full set of public details captured in the master guest workbook.',
  searchPlaceholder:
    'Search attendees by name, organisation, event, or note...',
  emptyTitle: 'No attendees found',
  emptyDescription:
    'Try a different name, organisation, or event filter to explore the public attendee directory.',
};

export const attendeeDirectoryConfig = {
  pageSize: 16,
  hiddenCategoryFilters: [
    'Panelist (7th Oct)',
...
export const hiddenPublicAttendeeIds = [
  'name-441',
  'truecaller-10',
...
export const publicAttendeeOverrides = {
  'snigdha-bhardwaj-1': {
    organisation: 'Google',
