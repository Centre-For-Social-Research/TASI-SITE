export const tasi2025HeroPills = [
  'October 7-8, 2025',
  'The Ambassador Hotel, New Delhi',
  '500+ Participants',
];

export const tasi2025Tracks = [
  {
...
export const tasi2025Recommendations = [
...
export const tasi2025FuturePriorities = [
...
export const tasi2025JourneyEditorialNotes = [
...
export const tasi2025JourneyTimeline = [
  {
    id: 1,
...
export const tasi2025KeynoteVideos = [
  {
    iframeSrc:
      'https://player.mux.com/k100u1ANRTgJCpEhVqJBpNxdREzMvhQWs1mE6IlSGeTE?metadata-video-title=Julie+Inman+Grant&video-title=Julie+Inman+Grant',
  ...
  {
    iframeSrc:
      'https://player.mux.com/l6f94UXaZxMGhwpwVNhzI61C02uYEexTJH02REw1i024Os?metadata-video-title=DELPHINE+O&video-title=DELPHINE+O',
...
export const tasi2025MediaLinks = [
  {
    label: 'Open Media Dossier',
    href: '/downloads/tasi-2025-media-coverage-dossier.pdf',
    external: true,
  },
  {
    label: 'Open Media Coverage Report',
    href: '/downloads/tasi-2025-media-coverage-report.pdf',
    external: true,
  },
  {
    label: 'View Media Page',
    href: '/media',
    external: false,
  },
];
