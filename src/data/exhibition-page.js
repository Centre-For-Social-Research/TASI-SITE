export const exhibitionMetadata = {
...
export const exhibitionHero = {
  eyebrow: 'TASI 2026',
  title: 'Participation & Exhibition',
  description:
...
export const exhibitionProofPoints = [
  {
...
export const exhibitionParticipationModes = [
  {
...
export const exhibitionExtendedBranding = [
  {
...
export const exhibitionValueCards = [
  {
