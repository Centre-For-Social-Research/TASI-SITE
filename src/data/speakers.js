export const speakers = [
  ...
  },
  {
    ...
    category: 'Creators & Public Educators',
    photo: 'Anupriya Kapur.webp',
  ...
  },
  {
    name: 'Deborah Fry',
    designation:
      'Global Director of Data and Principal Investigator (PI), Childlight',
    category: 'International',
  ...
  },
  {
    ...
    photo: 'Dr Nilesh Deshpande.webp',
  ...
  },
  {
    ...
    category: 'Creators & Public Educators',
    photo: 'Dr. Cuterus (Dr. Tanaya).webp',
  ...
  },
  {
    ...
    designation:
      'Member of Parliament, Lok Sabha and Member of Parliamentary Standing Committee on',
    category: 'Government',
    photo: 'Dr. Rabindra Narayan Behera.png',
    linkedinUrl:
      'https://www.linkedin.com/in/dr-rabindra-narayan-behera-883b371ab/',
  ...
  },
  {
    ...
    category: 'Diplomats',
    photo: 'Josephine van Zanten.webp',
  ...
  },
  {
    ...
    designation:
      'Programme Manager, Child Protection, Child in Need Institute (CINI)',
    category: 'Academia & Research',
    photo: 'Lena Dasgupta Basu.webp',
  ...
  },
  {
    name: 'Manisha Kapoor',
    designation:
      'CEO and Secretary-General, The Advertising Standards Council of India',
    category: 'Civil Society',
  ...
  {
    name: 'Prakshi Saha',
    designation: 'Founder, Frida Health',
    category: 'Civil Society',
    photo: 'Prakshi Saha.webp',
    bio: 'Prakshi Saha is the Founder of Frida- Women?s Health Advocacy Lab where they work on health, well-being and dignity of adolescent girls and women. They have launched India?s first ever Parliamentarians? Forum on Women?s Health. Prakshi is a lawyer by academic degree and has primarily worked as a policy researcher with Parliamentarians, governments, and think tanks. She also currently manages outreach, partnerships and stakeholder engagement at The Asian Collective for Health Systems comprising 10 South And Southeast Asian countries, prioritising the Asian voice in global health governance. She started her journey in the social impact space at 18. She has run numerous campaigns, and petitions engaging more than 1,00,000 citizens and elected representatives and directly worked with 5000+ women and girls from grassroots communities.',
  },
  {
    name: 'Rajesh Ranjan',
    designation:
      'Head of Core Government Affairs and Public Policy, Google India',
    category: 'Technology',
    photo: 'Rajesh Ranjan.webp',
  ...
  },
  {
    ...
    designation:
      'Fmr Senior Director (Retd.), Ministry of Information Technology, Government of India',
    category: 'Government',
    photo: 'Rakesh Maheshwari.webp',
  ...
  },
  {
    ...
    designation:
      'Feminist Activist and Global Expert on Gender Digital Rights, United Nations Young Activist',
    category: 'International',
    photo: 'Shanley Clemot McLaren.webp',
  ...
  },
  {
    ...
    designation:
      'Director and Global Head of Generative AI, Trust & Safety, Google',
    category: 'Technology',
    photo: 'Snigdha Bhardwaj.webp',
  ...
  },
  {
    ...
    designation: 'High Commissioner of Canada to India',
    category: 'Diplomats',
    photo: '/img/Speaker Highlights/Christopher Cooter.png',
    bio: "Christopher Cooter is Canada's High Commissioner to India following his 2025 appointment by Global Affairs Canada. A career Canadian diplomat, he has served in a range of international assignments and combines diplomatic experience with academic training in social work and psychology. His current role focuses on advancing the Canada-India relationship across diplomacy, trade, and people-to-people ties.",
  },
  {
    name: 'Jan Thesleff',
    ...
    bio: "Jan Thesleff is Sweden's Ambassador to India and is concurrently accredited to Bhutan, Maldives, Nepal, and Sri Lanka. He is a senior Swedish diplomat with decades of foreign-service experience, including earlier ambassadorial and policy assignments linked to the Middle East and broader international affairs. His work in New Delhi centers on deepening Sweden's strategic and economic partnership with India and the wider region.",
  },
  {
    name: 'Marisa Gerards',
    designation:
    ...
    bio: "Marisa Gerards has served as Ambassador of the Kingdom of the Netherlands to India since 2023, with concurrent accreditation to Nepal and Bhutan. Before moving to New Delhi, she was Director General at the Ministry of Defence in the Netherlands and earlier served as the Netherlands' Permanent Representative to NATO and Ambassador to South Africa. She is a career diplomat with three decades of experience across foreign affairs, environment, and security institutions.",
  },
  {
    name: 'Thierry Mathou',
    designation: 'Ambassador of France to India',
    category: 'Diplomats',
    photo: '/img/Speaker Highlights/Thierry Mathou.png',
    bio: 'Thierry Mathou is Ambassador of France to India. A career French diplomat and specialist in Asian affairs, he has held senior diplomatic assignments across Europe and Asia and has written on Himalayan and South Asian geopolitics, including Bhutan. His work in India has emphasized strategic ties, innovation, education, and cultural cooperation between France and India.',
  },
];
