              ...
              return (
                ...
                >
                  ...
                  <div className="flex items-start gap-4">
                    <div
                      className={`mt-0.5 flex h-12 w-12 flex-shrink-0 items-center justify-center rounded-[10px] ${s.iconBg}`}
                    >
                    ...
                    <div className="min-w-0 flex-1">
                      ...
                      <div className="mt-4 flex flex-wrap gap-2">
                        {s.pills.map((p) => (
                          <span
                            key={p}
                            className={`rounded-full px-2.5 py-0.5 text-xs font-medium ${s.pillBg} ${s.pillText}`}
                          >
                            {p}
                          </span>
                        ))}
