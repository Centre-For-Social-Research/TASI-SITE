...
const colorStyles = {
  sky:     { iconBg: "bg-sky-100 dark:bg-sky-900/40",         iconText: "text-sky-600 dark:text-sky-400",         border: "border-sky-200 dark:border-sky-800",         cardBg: "bg-sky-50 dark:bg-sky-950/20" },
  amber:   { iconBg: "bg-amber-100 dark:bg-amber-900/40",     iconText: "text-amber-600 dark:text-amber-400",     border: "border-amber-200 dark:border-amber-800",     cardBg: "bg-amber-50 dark:bg-amber-950/20" },
  purple:  { iconBg: "bg-purple-100 dark:bg-purple-900/40",   iconText: "text-purple-600 dark:text-purple-400",   border: "border-purple-200 dark:border-purple-800",   cardBg: "bg-purple-50 dark:bg-purple-950/20" },
  blue:    { iconBg: "bg-blue-100 dark:bg-blue-900/40",       iconText: "text-blue-600 dark:text-blue-400",       border: "border-blue-200 dark:border-blue-800",       cardBg: "bg-blue-50 dark:bg-blue-950/20" },
  yellow:  { iconBg: "bg-yellow-100 dark:bg-yellow-900/40",   iconText: "text-yellow-600 dark:text-yellow-400",   border: "border-yellow-200 dark:border-yellow-800",   cardBg: "bg-yellow-50 dark:bg-yellow-950/20" },
  green:   { iconBg: "bg-green-100 dark:bg-green-900/40",     iconText: "text-green-600 dark:text-green-400",     border: "border-green-200 dark:border-green-800",     cardBg: "bg-green-50 dark:bg-green-950/20" },
  emerald: { iconBg: "bg-emerald-100 dark:bg-emerald-900/40", iconText: "text-emerald-600 dark:text-emerald-400", border: "border-emerald-200 dark:border-emerald-800", cardBg: "bg-emerald-50 dark:bg-emerald-950/20" },
  red:     { iconBg: "bg-red-100 dark:bg-red-900/40",         iconText: "text-red-600 dark:text-red-400",         border: "border-red-200 dark:border-red-800",         cardBg: "bg-red-50 dark:bg-red-950/20" },
  violet:  { iconBg: "bg-violet-100 dark:bg-violet-900/40",   iconText: "text-violet-600 dark:text-violet-400",   border: "border-violet-200 dark:border-violet-800",   cardBg: "bg-violet-50 dark:bg-violet-950/20" },
  teal:    { iconBg: "bg-teal-100 dark:bg-teal-900/40",       iconText: "text-teal-600 dark:text-teal-400",       border: "border-teal-200 dark:border-teal-800",       cardBg: "bg-teal-50 dark:bg-teal-950/20" },
};
          ...
          <div className="grid grid-cols-2 gap-3 sm:grid-cols-3 lg:grid-cols-6">
            {quickStats.map((s) => (
              ...
              >
                ...
                <p className="mt-1 text-sm font-bold text-stone-900 dark:text-white">{s.value}</p>
              </div>
            ))}
          </div>
        </div>
        ...
        <div className="mx-auto max-w-5xl">
          <div className="mb-10">
            ...
            <p className="mt-3 max-w-2xl text-stone-600 dark:text-stone-400">
              Essential information for delegates travelling to New Delhi for TASI 2026.
            </p>
          </div>
          ...
          <div className="grid gap-5 sm:grid-cols-2">
            {infoItems.map((item) => {
              ...
              return (
                <div key={item.title} className={`rounded-[10px] border p-6 ${c.border} ${c.cardBg}`}>
                  ...
                  <p className="text-sm leading-relaxed text-stone-700 dark:text-stone-300">{item.body}</p>
                </div>
              );
            })}
          </div>
