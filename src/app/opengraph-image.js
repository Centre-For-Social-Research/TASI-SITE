...
export default function OpenGraphImage() {
  return new ImageResponse(
    (
      ...
      >
        <div style={{ display: "flex", fontSize: 28, letterSpacing: 2, opacity: 0.9 }}>
          TRUST AND SAFETY INDIA FESTIVAL
        </div>

        <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
          <div style={{ display: "flex", fontSize: 90, fontWeight: 800, lineHeight: 1 }}>
            TASI 2026
          </div>
          <div style={{ display: "flex", fontSize: 34, color: "#fde68a", lineHeight: 1.2 }}>
