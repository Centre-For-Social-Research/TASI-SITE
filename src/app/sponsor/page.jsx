      ...
      <main className="bg-white text-stone-900 dark:bg-stone-950 dark:text-stone-100">
        ...
        <section className="relative overflow-hidden bg-[linear-gradient(180deg,#fffaf2_0%,#f7ede0_100%)] py-12 dark:bg-[linear-gradient(180deg,#111827_0%,#0b1220_100%)] md:py-20">
          ...
          <div className="mx-auto grid w-full max-w-6xl gap-10 px-4 md:px-6 lg:grid-cols-[1.05fr_0.95fr]">
            <div>
              <p className="text-xs font-black uppercase tracking-[0.18em] text-rc-accent dark:text-white">Why Sponsor TASI</p>
            ...
            <div className="mt-8 grid gap-4 sm:grid-cols-3">
                {sponsorMetrics.map((item) => (
                  ...
                  >
                    <p className="text-2xl font-black tracking-tight text-rc-primary dark:text-white md:text-3xl">{item.value}</p>
            ...
            <article className="rounded-[10px] bg-[linear-gradient(135deg,#350265_0%,#5c0f4f_48%,#15002b_100%)] p-7 text-white shadow-[0_30px_80px_-34px_rgba(53,2,101,0.55)] md:p-9">
              <p className="text-xs font-black uppercase tracking-[0.18em] text-rc-secondary dark:text-white">What sponsors get</p>
              ...
              <p className="mt-5 text-base leading-relaxed text-white/82">
                Sponsors gain a platform to contribute to high-trust conversations, connect with decision-makers across sectors, and show visible commitment to safer digital ecosystems.
              </p>
        ...
        <section className="bg-[linear-gradient(180deg,#1a042b_0%,#2d0641_52%,#4f0d53_100%)] py-12 text-white md:py-20">
          <div className="mx-auto w-full max-w-6xl px-4 md:px-6">
            <div className="max-w-3xl">
              <p className="text-xs font-black uppercase tracking-[0.18em] text-rc-secondary dark:text-white">Sponsor Advantages</p>
              ...
              <p className="mt-5 text-base leading-relaxed text-white/80 md:text-lg">
                From policy visibility and thought leadership to strategic relationship-building, these advantages are designed to help sponsors show up with credibility and lasting relevance.
              </p>
            </div>
        ...
        <section id="sponsorship-tiers" className="bg-white py-12 dark:bg-stone-950 md:py-20">
        ...
        <section id="partner-options" className="bg-[linear-gradient(180deg,#fffdf8_0%,#f3ece4_100%)] pb-12 pt-0 dark:bg-[linear-gradient(180deg,#111827_0%,#0b1220_100%)] md:pb-20 md:pt-0">
          <div className="mx-auto grid w-full max-w-6xl scroll-mt-24 gap-6 px-4 md:px-6 lg:grid-cols-2">
            <article className="lg:col-span-2 rounded-[10px] border border-orange-200 bg-[linear-gradient(135deg,#fff4e8_0%,#fffaf5_60%,#ffffff_100%)] p-6 dark:border-slate-700 dark:bg-[linear-gradient(135deg,#fff4e8_0%,#fffaf5_60%,#ffffff_100%)] md:p-8">
              <div className="flex flex-col gap-5 md:flex-row md:items-center md:justify-between">
                <div className="max-w-2xl">
                  <p className="text-xs font-black uppercase tracking-[0.18em] text-orange-700 dark:!text-orange-700">Prospectus</p>
            ...
            {partnerOptions.map((item) => (
              ...
              >
                <p className="text-xs font-black uppercase tracking-[0.18em] text-rc-secondary dark:text-white">
                  {item.title === "Media or Association Partner" ? "Amplification" : "Custom Partnership"}
                </p>
                <h3 className="mt-3 text-2xl font-black tracking-tight md:text-3xl">{item.title}</h3>
                <p className="mt-4 max-w-xl text-sm leading-relaxed text-white/82 md:text-base">{item.body}</p>
