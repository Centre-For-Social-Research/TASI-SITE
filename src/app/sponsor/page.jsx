      ...
      <main>
        <section className="relative overflow-hidden bg-gradient-to-b from-stone-100 to-white py-14 dark:bg-[radial-gradient(circle_at_20%_0%,#1f2937_0%,#0b1220_45%,#05070e_100%)] md:py-20">
          ...
          <div className="relative z-10 mx-auto w-full max-w-6xl px-4 text-center md:px-6">
            ...
            <h1 className="text-4xl font-black tracking-tight text-stone-900 dark:text-slate-100 md:text-6xl">Sponsorship Opportunities</h1>
        ...
        <section className="bg-stone-100 py-14 md:py-16">
          <div className="mx-auto w-full max-w-6xl px-4 md:px-6">
            <h2 className="mb-8 text-center text-3xl font-black tracking-tight text-stone-900 md:text-5xl">Why Sponsor TASI 2026?</h2>
            <div className="grid gap-4 md:grid-cols-2 xl:grid-cols-3">
              {reasons.map((reason) => (
                <article key={reason} className="rounded-2xl border border-stone-200 bg-white p-5 text-stone-700">
                  {reason}
                </article>
              ))}
            </div>
        ...
        <section className="bg-white py-14 md:py-16">
          <div className="mx-auto w-full max-w-6xl px-4 md:px-6">
            <h2 className="mb-8 text-center text-3xl font-black tracking-tight text-stone-900 md:text-5xl">Sponsorship Tiers</h2>
              ...
              {tiers.map((tier) => (
                ...
                >
                  <div className="flex flex-wrap items-start justify-between gap-4">
                    <div>
                      <h3 className={`mb-2 text-xl font-bold ${tier.emphasis ? "text-orange-700" : "text-stone-900"}`}>
                        {tier.name}
                      </h3>
                      <p className="mb-2 text-3xl font-black text-orange-700">{tier.price}</p>
                    </div>
                    <a
                      className={[
            ...
            <div className="mx-auto mt-8 max-w-3xl rounded-2xl border border-stone-200 bg-stone-50 p-6">
              <h3 className="text-center text-2xl font-bold tracking-tight text-stone-900">Additional Sponsorship Opportunities</h3>
        ...
        <section className="bg-stone-100 py-14 md:py-16">
          <div className="mx-auto w-full max-w-6xl px-4 text-center md:px-6">
            ...
            <h2 className="mb-8 text-3xl font-black tracking-tight text-stone-900 md:text-5xl">Partners from TASI 2025</h2>
            <div className="grid gap-3 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-6">
              {partners.map((partner) => (
                <article
                  key={partner.name}
                  className="flex min-h-24 items-center justify-center rounded-xl border border-stone-200 bg-white px-4 py-3"
                >
                  <img
                    src={partner.logo}
                    alt={partner.name}
