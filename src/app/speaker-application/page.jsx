        ...
        <BrandedPageHero className="py-14 md:py-20">
          <div className="relative z-10 mx-auto w-full max-w-6xl px-4 text-center md:px-6">
            ...
            <p className="mx-auto mt-5 max-w-3xl text-base leading-relaxed text-white/90 md:text-lg">
              Bring a sharp perspective, a real-world case study, or a
              conversation that can move the field forward. We are looking for
              speakers who can turn trust and safety challenges into actionable
              dialogue.
            </p>
          </div>
        </BrandedPageHero>
              ...
              <div className="mt-auto pt-8">
                <div className="rounded-[10px] bg-[linear-gradient(135deg,#111827,#1f2937,#7c2d12)] px-5 py-5 text-white">
                  ...
                  <p className="mt-3 text-sm leading-relaxed text-white/85">
                    Share your proposed topic, the audience problem it
                    addresses, and why your voice is relevant for TASI 2026.
                    Panels, firesides, solo talks, cross-sector case studies,
                    and implementation-led sessions are all welcome.
                  </p>
                </div>
              </div>
            </div>
