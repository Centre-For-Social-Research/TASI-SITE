...
import { mediaCoverageEntries2025, mediaLogoWall2025 } from "@/data/media-coverage-2025";
          ...
          <div className="mx-auto w-full max-w-7xl px-4 md:px-6">
            <div className="mx-auto max-w-3xl text-center">
              ...
              <p className="mx-auto mt-8 max-w-2xl text-sm leading-relaxed text-stone-700 dark:text-slate-300 md:text-base">
                Don&apos;t miss the latest TASI media material. Everything here is designed to help journalists,
                editors, and event partners prepare coverage quickly.
              </p>
            </div>
