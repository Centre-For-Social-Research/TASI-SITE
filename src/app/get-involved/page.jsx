        ...
        <BrandedPageHero className="py-14 md:py-20">
          <div className="relative z-10 mx-auto w-full max-w-6xl px-4 text-center md:px-6">
            ...
            <p className="mx-auto mt-5 max-w-3xl text-base leading-relaxed text-white/90 md:text-lg">
              From sponsorships and speaking opportunities to media access,
              partner events, and delegation planning, there are multiple ways
              to take part in India&apos;s leading trust and safety convening.
            </p>
          ...
          <div className="grid gap-6 lg:grid-cols-[1.05fr_0.95fr]">
            ...
            <div className="rounded-[10px] border border-stone-200 bg-[linear-gradient(145deg,#111827,#1f2937,#7c2d12)] px-6 py-8 text-white shadow-[0_24px_80px_rgba(15,23,42,0.18)] sm:px-8">
              ...
              <p className="mt-4 text-base leading-relaxed text-white/80">
                If your team is exploring a delegation, a partner activation, a
                hosted roundtable, a research launch, or a media collaboration,
                we can help route you to the right format quickly.
              </p>
