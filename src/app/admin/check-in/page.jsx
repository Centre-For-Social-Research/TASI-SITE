  ...
  return (
    <main className="min-h-screen bg-[#0b0c0f] px-6 py-24 text-[#edf0f6]">
      <div className="mx-auto max-w-3xl rounded-[28px] border border-[#23262d] bg-[#111318] p-8">
        ...
        <h1 className="mt-3 font-admin-display text-4xl text-[#f5f6f8]">Check-in access is temporarily unavailable.</h1>
...
export default async function AdminCheckInPage() {
  ...
  if (!operator.authorized) {
    if (operator.reason === "unauthenticated") redirect("/sign-in?redirect_url=/admin/check-in");
