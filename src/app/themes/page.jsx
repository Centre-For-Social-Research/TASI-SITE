        ...
        <BrandedPageHero className="min-h-[320px] py-14 md:min-h-[380px] md:py-20">
          <div className="relative z-10 mx-auto w-full max-w-6xl px-4 text-center md:px-6">
            ...
            <p className="mx-auto mt-4 max-w-3xl text-white/90">
              TASI 2026 convenes leaders across government, industry, civil
              society, and academia to examine urgent questions shaping AI
              governance, digital trust, platform accountability, and safety
              outcomes.
            </p>
        ...
        <section className="bg-stone-100 py-14 dark:bg-stone-950 md:py-16">
          <div className="mx-auto w-full max-w-6xl px-4 md:px-6">
            ...
            <p className="mb-8 max-w-3xl text-stone-700 dark:text-slate-300">
              Fourteen interconnected themes spanning governance, platform
              accountability, digital wellbeing, and human safety, designed to
              move the conversation from dialogue to implementation.
            </p>
