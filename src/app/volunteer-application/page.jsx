        ...
        <section className="mx-auto mt-8 max-w-6xl px-6 sm:mt-10 sm:px-8 lg:mt-12">
          <div className="grid gap-8 lg:grid-cols-[1.02fr_0.98fr] lg:items-stretch">
            <div className="rounded-[2rem] border border-stone-200/80 bg-white/95 p-7 shadow-[0_24px_80px_rgba(15,23,42,0.08)] backdrop-blur dark:border-slate-800 dark:bg-slate-900/95 dark:shadow-[0_24px_80px_rgba(0,0,0,0.35)] sm:p-9">
              <p className="text-xs font-black uppercase tracking-[0.18em] text-orange-700 dark:text-orange-300">Why Volunteer</p>
              ...
              <div className="mt-7 grid gap-3 sm:grid-cols-2">
                {volunteerBenefits.map((benefit) => (
                  ...
                  >
                    <h3 className="text-base font-black tracking-tight text-stone-900 dark:text-white">{benefit.title}</h3>
                    <p className="mt-2 text-sm leading-relaxed text-stone-600 dark:text-slate-300">{benefit.description}</p>
                  </div>
                ))}
              </div>
        ...
        <section className="mx-auto mt-20 max-w-6xl px-6 sm:px-8">
          <div className="grid gap-6 lg:grid-cols-[0.95fr_1.05fr]">
            <div className="rounded-[2rem] border border-stone-200 bg-white px-6 py-8 shadow-[0_20px_60px_rgba(15,23,42,0.06)] dark:border-slate-800 dark:bg-slate-900 sm:px-8">
              <p className="text-xs font-black uppercase tracking-[0.18em] text-orange-700 dark:text-orange-300">Who Thrives Here</p>
              <h2 className="mt-4 text-3xl font-black tracking-tight text-stone-950 dark:text-white sm:text-4xl">
            ...
            <div className="rounded-[2rem] border border-stone-200 bg-white px-6 py-8 shadow-[0_20px_60px_rgba(15,23,42,0.06)] dark:border-slate-800 dark:bg-slate-900 sm:px-8">
              <p className="text-xs font-black uppercase tracking-[0.18em] text-orange-700 dark:text-orange-300">How It Works</p>
              <h2 className="mt-4 text-3xl font-black tracking-tight text-stone-950 dark:text-white sm:text-4xl">
                A simple application and coordination process
              </h2>
              <div className="mt-8 grid gap-4">
                {processSteps.map((step, index) => (
                  <div key={step} className="flex gap-4 rounded-[1.5rem] border border-stone-200 bg-stone-50 px-4 py-4 dark:border-slate-700 dark:bg-slate-800">
                    ...
                    <p className="pt-2 text-sm leading-relaxed text-stone-700 dark:text-slate-200">{step}</p>
                  </div>
                ))}
              </div>
              ...
              <div className="mt-8 rounded-[1.75rem] border border-orange-200 bg-orange-50 px-5 py-5 dark:border-orange-900/60 dark:bg-orange-950/30">
                <p className="text-xs font-black uppercase tracking-[0.18em] text-orange-700 dark:text-orange-300">Good To Know</p>
