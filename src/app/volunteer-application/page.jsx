        ...
        <BrandedPageHero className="py-14 md:py-20">
          <div className="relative z-10 mx-auto w-full max-w-6xl px-4 text-center md:px-6">
            ...
            <p className="mx-auto mt-5 max-w-3xl text-base leading-relaxed text-white/90 md:text-lg">
              Help us welcome attendees, support speakers, and keep the
              experience calm, thoughtful, and well-run. We are looking for
              volunteers who are dependable, warm, and excited to contribute to
              TASI 2026.
            </p>
          </div>
        </BrandedPageHero>
